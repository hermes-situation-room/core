...
const { formData, isJournalist, isActivist, selectUserType } = useUserType();
const { errorMessage, isLoading, handleRegister } = useRegister(formData, isActivist);
                        ...
                        <div class="card-body">
                            ...
                            <form @submit.prevent="handleRegister">
                                ...
                                <template v-if="isJournalist">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input v-model="formData.emailAddress" type="email" required
                                            class="form-control" placeholder="Enter your email" :disabled="isLoading" />
                                    </div>

                                    <div class="mb-4">
                                        <label class="form-label">Employer</label>
                                        <input v-model="formData.employer" type="text" required class="form-control"
                                            placeholder="Enter your employer" :disabled="isLoading" />
                                    </div>
                                </template>
                                ...
                                <template v-if="isActivist">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input v-model="formData.firstName" type="text" class="form-control"
                                                    placeholder="Optional" :disabled="isLoading" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Email Address</label>
                                        <input v-model="formData.emailAddress" type="email" class="form-control"
                                            placeholder="Optional" :disabled="isLoading" />
                                    </div>
                                    ...
                                    <div v-if="showPrivacySettings" class="card bg-light mb-4">
                                        <div class="card-body">
                                            ...
                                            <div v-if="formData.lastName" class="form-check mb-2">
                                                <input v-model="formData.isLastNameVisible" type="checkbox"
                                                    class="form-check-input" id="lastNameVisible" />
                                            ...
                                            <div v-if="formData.emailAddress" class="form-check">
                                                <input v-model="formData.isEmailVisible" type="checkbox"
                                                    class="form-check-input" id="emailVisible" />
