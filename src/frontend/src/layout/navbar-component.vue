        ...
        <nav class="navbar py-2 px-3" style="background-color: #F5F5F5;">
            <div class="container-fluid d-flex justify-content-between align-items-center flex-nowrap">
                <RouterLink to="/" class="navbar-brand d-flex align-items-center">
                    <img :src="logoUrl" alt="Situation Room logo" class="logo"
                ...
                <div class="d-flex align-items-center">
                    <RouterLink to="/login">
                        <v-icon class="icon"
                            ...
                            @mouseover="scaleUp" @mouseout="scaleDown">mdi-account-search
                        </v-icon>
                    </RouterLink>
                    ...
                    <RouterLink to="/login" style="margin-left: clamp(0.5rem, 2vw, 2rem);">
                        <v-icon class="icon"
                            style="font-size: clamp(1.25rem, 3vw, 2rem); cursor: pointer; transition: transform 0.2s ease; color: #000;"
                            @mouseover="scaleUp" @mouseout="scaleDown">mdi-message-processing-outline
                        </v-icon>
                    </RouterLink>
                    ...
                    <RouterLink to="/login" style="margin-left: clamp(0.5rem, 2vw, 2rem);">
                        <v-icon class="icon"
                            style="font-size: clamp(1.25rem, 3vw, 2rem); cursor: pointer; transition: transform 0.2s ease; color: #000;"
                            @mouseover="scaleUp" @mouseout="scaleDown">mdi-account-circle
                        </v-icon>
                    </RouterLink>
                </div>
            </div>
